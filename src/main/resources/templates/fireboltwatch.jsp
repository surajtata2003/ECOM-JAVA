...
<div class="product-container">
    <div class="slideshow">
        <div class="slide fade">
            <img src="https://m.media-amazon.com/images/I/61ArSKA048L._SX679_.jpg">
        </div>
        <div class="slide fade">
            <img src="https://m.media-amazon.com/images/I/61U+9QRQnnL._SX679_.jpg">
        </div>
        <div class="slide fade">
            <img src="https://m.media-amazon.com/images/I/71u05p+zyyL._SX679_.jpg">
        </div>
    </div>
    <div class="product-info">
        <h1>Fire-Boltt Phoenix  </h1>
        ...
        <p>Model Name	Fire-Boltt Phoenix </p>
        <p>Colour:Black</p>
        <p>Special Feature	Accelerometer, Activity Tracker, Alarm Clock, Breathe, SpO2, Heart Rate Tracking, AMOLED Display, 466*466 pixel high resolution, Bluetooth Calling , 100+ Sports Mode Tracking, In Built Mic & Speaker,IP68 Rating, Multisport Tracker, Music Player, Notifications, Pedometer, Phone Call, Calorie Tracker, Camera, Daily Workout Memory, Distance Tracker, Sedentary Reminder, Sleep Monitor, Text message, Time DisplayAccelerometer, Activity Tracker, Alarm Clock, Breathe, SpO2, Heart Rate Tracking, AMOLED Display, 466*466 pixel high resolution, Bluetoot…</p>
        <p>About this item:</p>
        <ul>
...
<div class="product-table">
    <table>
        <tr>
            <td>
                <a href=https://www.amazon.in/Fire-Boltt-Bluetooth-Smartwatch-Assistant-Monitoring/dp/B0BRKXXPZ7/ref=sr_1_2_sspa?keywords=firebolt%2Blatest%2Bsmart%2Bwatch%2B2022&qid=1697301860&sr=8-2-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1>
        ...
        <tr>
            <td>
                <a href=https://www.flipkart.com/fire-boltt-firebolt-smartwatch/p/itmc3e121afad036>
