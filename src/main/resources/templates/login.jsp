  ...
  <nav class="navbar navbar-expand-lg navbar-dark justify-content-between">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <button href="login1" class="login-button">Login</button>                </ul>
            </div>
        </div>
    </nav>
    
    <div class="container d-flex justify-content-center align-items-center">
<form class="form" method="post" th:ob"${stud0}" action="/login_process">
    <div class="flex-column">
      <label>Email </label></div>
      <div class="inputForm">
        <svg height="20" viewBox="0 0 32 32" width="20" xmlns="http://www.w3.org/2000/svg"><g id="loginid" data-name="loginid"><path d="m30.853 13.87a15 15 0 0 0 -29.729 4.082 15.1 15.1 0 0 0 12.876 12.918 15.6 15.6 0 0 0 2.016.13 14.85 14.85 0 0 0 7.715-2.145 1 1 0 1 0 -1.031-1.711 13.007 13.007 0 1 1 5.458-6.529 2.149 2.149 0 0 1 -4.158-.759v-10.856a1 1 0 0 0 -2 0v1.726a8 8 0 1 0 .2 10.325 4.135 4.135 0 0 0 7.83.274 15.2 15.2 0 0 0 .823-7.455zm-14.853 8.13a6 6 0 1 1 6-6 6.006 6.006 0 0 1 -6 6z"></path></g></svg>
        <input type="text" class="input" id="loginid" name="email" placeholder="Enter your Email">
      </div>
    ...
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="password" class="input" id="loginpass" name="pass" placeholder="Enter your Password">
   ...
   <!--  <input type="submit" class="button-submit" value="Register"> -->
    ...
    <p class="p">Don't have an account? <a href="register" class="span">Sign Up</a></p>
