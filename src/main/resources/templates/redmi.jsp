...
<div class="product-container">
    <div class="slideshow">
        <div class="slide fade">
            <img src="https://m.media-amazon.com/images/I/41gbs1aJDPL._SX300_SY300_QL70_FMwebp_.jpg">
        </div>
        <div class="slide fade">
            <img src="https://m.media-amazon.com/images/I/81TICIfkcQL._SX679_.jpg">
        </div>
        <div class="slide fade">
            <img src="https://m.media-amazon.com/images/I/81Ow8AkRZaL._SX679_.jpg">
        </div>
    </div>
    <div class="product-info">
        <h1>Redmi A2 (Classic Black, 2GB RAM, 64GB Storage)</h1>
        ...
        <p>Brand	Redmi</p>
        <p>Model Name	Redmi A2</p>
        <p>Colour: Black</p>
        <p>Network Service Provider	Unlocked for All Carriers</p>
        <p>Operating System	Android 13 Go, Android 13.0</p>
        <p>About this item:</p>
        <ul>
            <li>Processor: High performance MediaTek Helio G36,upto 2.2GHz; | Upto 4GB RAM including 2GB Virtual RAM | 64GB Storage</li>
            <li>Display: Large 16.5 cm HD+ display with Scratch resistant glass | 400nits peak brightness | 120Hz Touch sampling Rate</li>
            <li>Camera: 8MP Dual camera with Portrait mode | 5MP Front camera</li>
        </ul>
    </div>
</div>
<div class="product-table">
    <table>
        <tr>
            <td>
                <a href=https://www.amazon.in/Redmi-Classic-Black-64GB-Storage/dp/B0C74KRMHW?th=1>
        ...
        <tr>
            <td>
                <a href=https://www.flipkart.com/redmi-a2-classic-black-64-gb/p/itm0514f7bd62f02>
